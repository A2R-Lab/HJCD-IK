...
namespace grid {
    ...
    template <typename T>
    __device__ void update_singleJointX(
        T* s_jointXforms,
        T* s_XmatsHom,
        T* s_q,
        int tid
    ) {
        T sin_x0 = sin(s_q[0]); T cos_x0 = cos(s_q[0]);
        T sin_x1 = sin(s_q[1]); T cos_x1 = cos(s_q[1]);
        T sin_x2 = sin(s_q[2]); T cos_x2 = cos(s_q[2]);
        T sin_x3 = sin(s_q[3]); T cos_x3 = cos(s_q[3]);
        T sin_x4 = sin(s_q[4]); T cos_x4 = cos(s_q[4]);
        T sin_x5 = sin(s_q[5]); T cos_x5 = cos(s_q[5]);
        T sin_x6 = sin(s_q[6]); T cos_x6 = cos(s_q[6]);

        s_XmatsHom[0] = cos_x0;   // cos(q0)
        s_XmatsHom[1] = sin_x0;   // sin(q0)
        s_XmatsHom[4] = -sin_x0;
        s_XmatsHom[5] = cos_x0;

        s_XmatsHom[16] = cos_x1;
        s_XmatsHom[18] = -sin_x1;
        s_XmatsHom[20] = -sin_x1;
        s_XmatsHom[22] = -cos_x1;

        s_XmatsHom[32] = cos_x2;
        s_XmatsHom[34] = sin_x2;
        s_XmatsHom[36] = -sin_x2;
        s_XmatsHom[38] = cos_x2;

        s_XmatsHom[48] = cos_x3;
        s_XmatsHom[50] = sin_x3;
        s_XmatsHom[52] = -sin_x3;
        s_XmatsHom[54] = cos_x3;

        s_XmatsHom[64] = cos_x4;
        s_XmatsHom[66] = -sin_x4;
        s_XmatsHom[68] = -sin_x4;
        s_XmatsHom[70] = -cos_x4;

        s_XmatsHom[80] = cos_x5;
        s_XmatsHom[82] = sin_x5;
        s_XmatsHom[84] = -sin_x5;
        s_XmatsHom[86] = cos_x5;

        s_XmatsHom[96] = cos_x6;
        s_XmatsHom[98] = sin_x6;
        s_XmatsHom[100] = -sin_x6;
        s_XmatsHom[102] = cos_x6;
        ...
        T j1_8, j2_8, j3_8, j4_8, j5_8, j6_8, j7_8;
        T j1_9, j2_9, j3_9, j4_9, j5_9, j6_9, j7_9;
        T j1_10, j2_10, j3_10, j4_10, j5_10, j6_10, j7_10;
        ...
        if (tid >= 1) {
            j2_0 = j1_0 * s_XmatsHom[16] + j1_4 * s_XmatsHom[16 + 1] + j1_8 * s_XmatsHom[16 + 2];
            j2_1 = j1_1 * s_XmatsHom[16] + j1_5 * s_XmatsHom[16 + 1] + j1_9 * s_XmatsHom[16 + 2];
            j2_2 = j1_2 * s_XmatsHom[16] + j1_6 * s_XmatsHom[16 + 1] + j1_10 * s_XmatsHom[16 + 2];
            j2_4 = j1_0 * s_XmatsHom[16 + 4] + j1_4 * s_XmatsHom[16 + 5] + j1_8 * s_XmatsHom[16 + 6];
            j2_5 = j1_1 * s_XmatsHom[16 + 4] + j1_5 * s_XmatsHom[16 + 5] + j1_9 * s_XmatsHom[16 + 6];
            j2_6 = j1_2 * s_XmatsHom[16 + 4] + j1_6 * s_XmatsHom[16 + 5] + j1_10 * s_XmatsHom[16 + 6];
            j2_8 = j1_0 * s_XmatsHom[16 + 8] + j1_4 * s_XmatsHom[16 + 9] + j1_8 * s_XmatsHom[16 + 10];
            j2_9 = j1_1 * s_XmatsHom[16 + 8] + j1_5 * s_XmatsHom[16 + 9] + j1_9 * s_XmatsHom[16 + 10];
            j2_10 = j1_2 * s_XmatsHom[16 + 8] + j1_6 * s_XmatsHom[16 + 9] + j1_10 * s_XmatsHom[16 + 10];
            j2_12 = j1_0 * s_XmatsHom[16 + 12] + j1_4 * s_XmatsHom[16 + 13] + j1_8 * s_XmatsHom[16 + 14] + j1_12;
            j2_13 = j1_1 * s_XmatsHom[16 + 12] + j1_5 * s_XmatsHom[16 + 13] + j1_9 * s_XmatsHom[16 + 14] + j1_13;
            j2_14 = j1_2 * s_XmatsHom[16 + 12] + j1_6 * s_XmatsHom[16 + 13] + j1_10 * s_XmatsHom[16 + 14] + j1_14;
        }
        if (tid >= 2) {
            j3_0 = j2_0 * s_XmatsHom[16 * 2] + j2_4 * s_XmatsHom[16 * 2 + 1] + j2_8 * s_XmatsHom[16 * 2 + 2];
            j3_1 = j2_1 * s_XmatsHom[16 * 2] + j2_5 * s_XmatsHom[16 * 2 + 1] + j2_9 * s_XmatsHom[16 * 2 + 2];
            j3_2 = j2_2 * s_XmatsHom[16 * 2] + j2_6 * s_XmatsHom[16 * 2 + 1] + j2_10 * s_XmatsHom[16 * 2 + 2];
            j3_4 = j2_0 * s_XmatsHom[16 * 2 + 4] + j2_4 * s_XmatsHom[16 * 2 + 5] + j2_8 * s_XmatsHom[16 * 2 + 6];
            j3_5 = j2_1 * s_XmatsHom[16 * 2 + 4] + j2_5 * s_XmatsHom[16 * 2 + 5] + j2_9 * s_XmatsHom[16 * 2 + 6];
            j3_6 = j2_2 * s_XmatsHom[16 * 2 + 4] + j2_6 * s_XmatsHom[16 * 2 + 5] + j2_10 * s_XmatsHom[16 * 2 + 6];
            j3_8 = j2_0 * s_XmatsHom[16 * 2 + 8] + j2_4 * s_XmatsHom[16 * 2 + 9] + j2_8 * s_XmatsHom[16 * 2 + 10];
            j3_9 = j2_1 * s_XmatsHom[16 * 2 + 8] + j2_5 * s_XmatsHom[16 * 2 + 9] + j2_9 * s_XmatsHom[16 * 2 + 10];
            j3_10 = j2_2 * s_XmatsHom[16 * 2 + 8] + j2_6 * s_XmatsHom[16 * 2 + 9] + j2_10 * s_XmatsHom[16 * 2 + 10];
            j3_12 = j2_0 * s_XmatsHom[16 * 2 + 12] + j2_4 * s_XmatsHom[16 * 2 + 13] + j2_8 * s_XmatsHom[16 * 2 + 14] + j2_12;
            j3_13 = j2_1 * s_XmatsHom[16 * 2 + 12] + j2_5 * s_XmatsHom[16 * 2 + 13] + j2_9 * s_XmatsHom[16 * 2 + 14] + j2_13;
            j3_14 = j2_2 * s_XmatsHom[16 * 2 + 12] + j2_6 * s_XmatsHom[16 * 2 + 13] + j2_10 * s_XmatsHom[16 * 2 + 14] + j2_14;
        }
        if (tid >= 3) {
            j4_0 = j3_0 * s_XmatsHom[16 * 3] + j3_4 * s_XmatsHom[16 * 3 + 1] + j3_8 * s_XmatsHom[16 * 3 + 2];
            j4_1 = j3_1 * s_XmatsHom[16 * 3] + j3_5 * s_XmatsHom[16 * 3 + 1] + j3_9 * s_XmatsHom[16 * 3 + 2];
            j4_2 = j3_2 * s_XmatsHom[16 * 3] + j3_6 * s_XmatsHom[16 * 3 + 1] + j3_10 * s_XmatsHom[16 * 3 + 2];
            j4_4 = j3_0 * s_XmatsHom[16 * 3 + 4] + j3_4 * s_XmatsHom[16 * 3 + 5] + j3_8 * s_XmatsHom[16 * 3 + 6];
            j4_5 = j3_1 * s_XmatsHom[16 * 3 + 4] + j3_5 * s_XmatsHom[16 * 3 + 5] + j3_9 * s_XmatsHom[16 * 3 + 6];
            j4_6 = j3_2 * s_XmatsHom[16 * 3 + 4] + j3_6 * s_XmatsHom[16 * 3 + 5] + j3_10 * s_XmatsHom[16 * 3 + 6];
            j4_8 = j3_0 * s_XmatsHom[16 * 3 + 8] + j3_4 * s_XmatsHom[16 * 3 + 9] + j3_8 * s_XmatsHom[16 * 3 + 10];
            j4_9 = j3_1 * s_XmatsHom[16 * 3 + 8] + j3_5 * s_XmatsHom[16 * 3 + 9] + j3_9 * s_XmatsHom[16 * 3 + 10];
            j4_10 = j3_2 * s_XmatsHom[16 * 3 + 8] + j3_6 * s_XmatsHom[16 * 3 + 9] + j3_10 * s_XmatsHom[16 * 3 + 10];
            j4_12 = j3_0 * s_XmatsHom[16 * 3 + 12] + j3_4 * s_XmatsHom[16 * 3 + 13] + j3_8 * s_XmatsHom[16 * 3 + 14] + j3_12;
            j4_13 = j3_1 * s_XmatsHom[16 * 3 + 12] + j3_5 * s_XmatsHom[16 * 3 + 13] + j3_9 * s_XmatsHom[16 * 3 + 14] + j3_13;
            j4_14 = j3_2 * s_XmatsHom[16 * 3 + 12] + j3_6 * s_XmatsHom[16 * 3 + 13] + j3_10 * s_XmatsHom[16 * 3 + 14] + j3_14;
        }
        if (tid >= 4) {
            j5_0 = j4_0 * s_XmatsHom[16 * 4] + j4_4 * s_XmatsHom[16 * 4 + 1] + j4_8 * s_XmatsHom[16 * 4 + 2];
            j5_1 = j4_1 * s_XmatsHom[16 * 4] + j4_5 * s_XmatsHom[16 * 4 + 1] + j4_9 * s_XmatsHom[16 * 4 + 2];
            j5_2 = j4_2 * s_XmatsHom[16 * 4] + j4_6 * s_XmatsHom[16 * 4 + 1] + j4_10 * s_XmatsHom[16 * 4 + 2];
            j5_4 = j4_0 * s_XmatsHom[16 * 4 + 4] + j4_4 * s_XmatsHom[16 * 4 + 5] + j4_8 * s_XmatsHom[16 * 4 + 6];
            j5_5 = j4_1 * s_XmatsHom[16 * 4 + 4] + j4_5 * s_XmatsHom[16 * 4 + 5] + j4_9 * s_XmatsHom[16 * 4 + 6];
            j5_6 = j4_2 * s_XmatsHom[16 * 4 + 4] + j4_6 * s_XmatsHom[16 * 4 + 5] + j4_10 * s_XmatsHom[16 * 4 + 6];
            j5_8 = j4_0 * s_XmatsHom[16 * 4 + 8] + j4_4 * s_XmatsHom[16 * 4 + 9] + j4_8 * s_XmatsHom[16 * 4 + 10];
            j5_9 = j4_1 * s_XmatsHom[16 * 4 + 8] + j4_5 * s_XmatsHom[16 * 4 + 9] + j4_9 * s_XmatsHom[16 * 4 + 10];
            j5_10 = j4_2 * s_XmatsHom[16 * 4 + 8] + j4_6 * s_XmatsHom[16 * 4 + 9] + j4_10 * s_XmatsHom[16 * 4 + 10];
            j5_12 = j4_0 * s_XmatsHom[16 * 4 + 12] + j4_4 * s_XmatsHom[16 * 4 + 13] + j4_8 * s_XmatsHom[16 * 4 + 14] + j4_12;
            j5_13 = j4_1 * s_XmatsHom[16 * 4 + 12] + j4_5 * s_XmatsHom[16 * 4 + 13] + j4_9 * s_XmatsHom[16 * 4 + 14] + j4_13;
            j5_14 = j4_2 * s_XmatsHom[16 * 4 + 12] + j4_6 * s_XmatsHom[16 * 4 + 13] + j4_10 * s_XmatsHom[16 * 4 + 14] + j4_14;
        }
        if (tid >= 5) {
            j6_0 = j5_0 * s_XmatsHom[16 * 5] + j5_4 * s_XmatsHom[16 * 5 + 1] + j5_8 * s_XmatsHom[16 * 5 + 2];
            j6_1 = j5_1 * s_XmatsHom[16 * 5] + j5_5 * s_XmatsHom[16 * 5 + 1] + j5_9 * s_XmatsHom[16 * 5 + 2];
            j6_2 = j5_2 * s_XmatsHom[16 * 5] + j5_6 * s_XmatsHom[16 * 5 + 1] + j5_10 * s_XmatsHom[16 * 5 + 2];
            j6_4 = j5_0 * s_XmatsHom[16 * 5 + 4] + j5_4 * s_XmatsHom[16 * 5 + 5] + j5_8 * s_XmatsHom[16 * 5 + 6];
            j6_5 = j5_1 * s_XmatsHom[16 * 5 + 4] + j5_5 * s_XmatsHom[16 * 5 + 5] + j5_9 * s_XmatsHom[16 * 5 + 6];
            j6_6 = j5_2 * s_XmatsHom[16 * 5 + 4] + j5_6 * s_XmatsHom[16 * 5 + 5] + j5_10 * s_XmatsHom[16 * 5 + 6];
            j6_8 = j5_0 * s_XmatsHom[16 * 5 + 8] + j5_4 * s_XmatsHom[16 * 5 + 9] + j5_8 * s_XmatsHom[16 * 5 + 10];
            j6_9 = j5_1 * s_XmatsHom[16 * 5 + 8] + j5_5 * s_XmatsHom[16 * 5 + 9] + j5_9 * s_XmatsHom[16 * 5 + 10];
            j6_10 = j5_2 * s_XmatsHom[16 * 5 + 8] + j5_6 * s_XmatsHom[16 * 5 + 9] + j5_10 * s_XmatsHom[16 * 5 + 10];
            j6_12 = j5_0 * s_XmatsHom[16 * 5 + 12] + j5_4 * s_XmatsHom[16 * 5 + 13] + j5_8 * s_XmatsHom[16 * 5 + 14] + j5_12;
            j6_13 = j5_1 * s_XmatsHom[16 * 5 + 12] + j5_5 * s_XmatsHom[16 * 5 + 13] + j5_9 * s_XmatsHom[16 * 5 + 14] + j5_13;
            j6_14 = j5_2 * s_XmatsHom[16 * 5 + 12] + j5_6 * s_XmatsHom[16 * 5 + 13] + j5_10 * s_XmatsHom[16 * 5 + 14] + j5_14;
        }
        if (tid >= 6) {
            j7_0 = j6_0 * s_XmatsHom[16 * 6] + j6_4 * s_XmatsHom[16 * 6 + 1] + j6_8 * s_XmatsHom[16 * 6 + 2];
            j7_1 = j6_1 * s_XmatsHom[16 * 6] + j6_5 * s_XmatsHom[16 * 6 + 1] + j6_9 * s_XmatsHom[16 * 6 + 2];
            j7_2 = j6_2 * s_XmatsHom[16 * 6] + j6_6 * s_XmatsHom[16 * 6 + 1] + j6_10 * s_XmatsHom[16 * 6 + 2];
            j7_4 = j6_0 * s_XmatsHom[16 * 6 + 4] + j6_4 * s_XmatsHom[16 * 6 + 5] + j6_8 * s_XmatsHom[16 * 6 + 6];
            j7_5 = j6_1 * s_XmatsHom[16 * 6 + 4] + j6_5 * s_XmatsHom[16 * 6 + 5] + j6_9 * s_XmatsHom[16 * 6 + 6];
            j7_6 = j6_2 * s_XmatsHom[16 * 6 + 4] + j6_6 * s_XmatsHom[16 * 6 + 5] + j6_10 * s_XmatsHom[16 * 6 + 6];
            j7_8 = j6_0 * s_XmatsHom[16 * 6 + 8] + j6_4 * s_XmatsHom[16 * 6 + 9] + j6_8 * s_XmatsHom[16 * 6 + 10];
            j7_9 = j6_1 * s_XmatsHom[16 * 6 + 8] + j6_5 * s_XmatsHom[16 * 6 + 9] + j6_9 * s_XmatsHom[16 * 6 + 10];
            j7_10 = j6_2 * s_XmatsHom[16 * 6 + 8] + j6_6 * s_XmatsHom[16 * 6 + 9] + j6_10 * s_XmatsHom[16 * 6 + 10];
            j7_12 = j6_0 * s_XmatsHom[16 * 6 + 12] + j6_4 * s_XmatsHom[16 * 6 + 13] + j6_8 * s_XmatsHom[16 * 6 + 14] + j6_12;
            j7_13 = j6_1 * s_XmatsHom[16 * 6 + 12] + j6_5 * s_XmatsHom[16 * 6 + 13] + j6_9 * s_XmatsHom[16 * 6 + 14] + j6_13;
            j7_14 = j6_2 * s_XmatsHom[16 * 6 + 12] + j6_6 * s_XmatsHom[16 * 6 + 13] + j6_10 * s_XmatsHom[16 * 6 + 14] + j6_14;
        }
        ...
        if (tid >= 0) {
            ...
            s_jointXforms[8] = j1_8;
            s_jointXforms[9] = j1_9;
            s_jointXforms[10] = j1_10;
        ...
        if (tid >= 1) {
            ...
            s_jointXforms[16 * 1 + 8] = j2_8;
            s_jointXforms[16 * 1 + 9] = j2_9;
            s_jointXforms[16 * 1 + 10] = j2_10;
        ...
        if (tid >= 2) {
            ...
            s_jointXforms[16 * 2 + 8] = j3_8;
            s_jointXforms[16 * 2 + 9] = j3_9;
            s_jointXforms[16 * 2 + 10] = j3_10;
        ...
        if (tid >= 3) {
            ...
            s_jointXforms[16 * 3 + 8] = j4_8;
            s_jointXforms[16 * 3 + 9] = j4_9;
            s_jointXforms[16 * 3 + 10] = j4_10;
        ...
        if (tid >= 4) {
            ...
            s_jointXforms[16 * 4 + 8] = j5_8;
            s_jointXforms[16 * 4 + 9] = j5_9;
            s_jointXforms[16 * 4 + 10] = j5_10;
        ...
        if (tid >= 5) {
            ...
            s_jointXforms[16 * 5 + 8] = j6_8;
            s_jointXforms[16 * 5 + 9] = j6_9;
            s_jointXforms[16 * 5 + 10] = j6_10;
        ...
        if (tid >= 6) {
            ...
            s_jointXforms[16 * 6 + 8] = j7_8;
            s_jointXforms[16 * 6 + 9] = j7_9;
            s_jointXforms[16 * 6 + 10] = j7_10;
    ...
    template <typename T>
    __device__ void update_jointTransforms(
        T* s_jointXforms,
        T* s_XmatsHom,
        T* s_q,
        T* s_temp) {
